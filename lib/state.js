...
var GsdState = class {
  ...
  _nextActionFor(step) {
    return { spec: "discuss-phase", discuss: "discuss-phase", ui: "ui-phase", plan: "plan-phase", execute: "execute-phase", verify: "verify-phase", ship: "ship-phase", done: null }[step] || "discuss-phase";
  }
