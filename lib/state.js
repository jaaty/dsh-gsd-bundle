...
var GsdState = class {
  ...
  _nextActionFor(step) {
    return { spec: "discuss-phase", discuss: "discuss-phase", ui: "ui-phase", plan: "plan-phase", "gap-analysis": "gap-analysis-phase", execute: "execute-phase", review: "verify-phase", "ui-review": "verify-phase", verify: "verify-phase", ship: "ship-phase", done: null }[step] || "discuss-phase";
  }
