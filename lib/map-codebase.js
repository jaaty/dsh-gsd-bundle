...
import { buildManifest, compareManifest } from "./_intel.js";
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args, exec) {
      ...
      if (q) {
        ...
        const prompt = ["Question: " + q, pc.text, CODEBASE_QUERY_PROMPT].join("\n\n");
        ...
        return { kind: "answer", text: pc.truncated.length
