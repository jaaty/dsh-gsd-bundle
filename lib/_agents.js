...
6. If a checkpoint:* task: stop and return a structured checkpoint object with exactly these keys — "plan" (the plan id), "last_completed_task" (integer index of the last task you completed), "checkpoint_reason" (a short string describing why you stopped), and "committed_hashes" (an array of commit SHAs you committed through that task). Do NOT proceed to later tasks.
