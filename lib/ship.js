...
import { runCapabilityGates, fetchGitData } from "./gates.js";

const GATE_NAMES = ["security", "broken_windows", "tdd_audit"];
...
function apply(ctx) {
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args, exec) {
      ...
      const gitData = fetchGitData(cwd, git, defaultBranch);
