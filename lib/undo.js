...
// are unit-testable directly (D-12, mirroring _shared.js /
...
import { parseNameStatusZ } from "./_shared.js";
...
function apply(ctx) {
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args, exec) {
      ...
      // Best-effort fetch so origin/<base> is a valid local ref (mirror _shared).
