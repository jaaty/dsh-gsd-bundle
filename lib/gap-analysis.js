...
// Parse D-NN decision IDs from a CONTEXT.md body. Matches the exact discuss.js
// format `- **D-NN:** text` (lib/discuss.js:138). The closing `**:` bounds the
// digits so D-01 never matches D-010 (whole-ID safety, D-13 b). Returns a
// deduped ascending list.
