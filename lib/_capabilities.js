...
// The 12 known capability keys, in a stable order: the onboarding map step
...
// execute -> verify -> ship). gap-analysis (order 22) slots between plan(20)
// and quick(25) per phase 37 D-02.
