...
// The 14 known capability keys, in a stable order: the onboarding map step
...
// execute -> code-review -> ui-review -> verify -> ship). gap-analysis (order
// 22) slots between plan(20) and quick(25) per phase 37 D-02; code-review (order
// 35) slots between execute(30) and verify(40) per phase 38 D-02; ui-review
