...
const TABLE = {
  ...
  gsdOrient: {
    step: "orient",
    role: "orient",
    tools: ["gsd_init", "gsd_status", "gsd_progress", "gsd_new_milestone", "gsd_pause_work", "gsd_resume_work", "gsd_next"],
    commands: ["gsd-init", "gsd-status", "gsd-progress", "gsd-new-milestone", "gsd-pause-work", "gsd-resume-work", "gsd-next"],
