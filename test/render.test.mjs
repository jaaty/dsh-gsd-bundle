...
const LOOP_ORDER = ["gsdSpec", "gsdDiscuss", "gsdUi", "gsdPlan", "gsdGapAnalysis", "gsdQuick", "gsdExecute", "gsdCodeReview", "gsdUiReview", "gsdVerify", "gsdValidatePhase", "gsdShip", "gsdMilestoneAudit", "gsdLearnings"];
...
describe("loopSteps / informationEntries ordering (D-08)", () => {
  ...
  test("loopSteps excludes a removed step and keeps ascending order", () => {
    ...
    assert.deepEqual(
      ...
      ["gsdSpec", "gsdDiscuss", "gsdUi", "gsdPlan", "gsdGapAnalysis", "gsdQuick", "gsdExecute", "gsdCodeReview", "gsdUiReview", "gsdValidatePhase", "gsdShip", "gsdMilestoneAudit", "gsdLearnings"],
    );
  });
...
describe("effectiveRoutableStep (D-04/D-06/D-10)", () => {
  ...
  test("advances to the nearest present step with strictly greater order when target is absent", () => {
    ...
    assert.equal(effectiveRoutableStep("verify-phase", without("gsdVerify", "gsdValidatePhase", "gsdShip", "gsdMilestoneAudit", "gsdLearnings")), null);
  });
