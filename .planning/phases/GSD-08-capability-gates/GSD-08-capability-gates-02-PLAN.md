...
<task type="auto">
  ...
  <verify>node --test test/gates.test.mjs 2>&1 | tail -20</verify>
  <acceptance_criteria>
...
<task type="auto">
  ...
  <verify>node --test test/gates.test.mjs 2>&1 | tail -20 && node --test test/service-tools.test.mjs 2>&1 | tail -10</verify>
  <acceptance_criteria>
