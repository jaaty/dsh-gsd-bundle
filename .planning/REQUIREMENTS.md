...
- [x] CLH-09: Review-fix companion: the gsd_code_review fix flag applies REVIEW.md findings as per-fix atomic commits into REVIEW-FIX.md and works in live sessions.
