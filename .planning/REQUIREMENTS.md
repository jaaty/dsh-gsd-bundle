...
- [ ] PUB-01: The repository includes an MIT LICENSE file so GitHub detects the license and users can legally use, modify, and redistribute the bundle.
- [ ] PUB-02: The README's attribution to opengsd-core is accurate and license-compliant, and the broken gsd-core-reference.md reference is fixed (the file is added with proper attribution, or the reference is removed).
